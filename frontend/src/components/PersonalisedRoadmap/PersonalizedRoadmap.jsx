...
const data = {
  ...
  currentSkills: ["Python", "NumPy", "Pandas", "SQL", "Git"],
  salary: "155k",
  description: "Transform your career with a structured learning path tailored to your current skills and target role. Master cutting-edge ML techniques and land your dream job.",
  growth: "65% salary increase potential",
  personalizedSteps: [
    {
      title: "Python Fundamentals & Data Structures",
      requiredSkills: ["Advanced Python", "Data Structures", "Algorithms", "OOP"],
      description: "Master advanced Python concepts and fundamental data structures essential for ML development.",
      topicNames: [
      ...
      resources: [
        {
          name: "Python Advanced Course - CampusX",
          type: "course",
    ...
    },
    {
      ...
      requiredSkills: ["Statistics", "Linear Algebra", "Calculus", "Probability"],
      description: "Build strong mathematical foundations required for understanding and implementing machine learning algorithms.",
      topicNames: [
    ...
    },
    {
      ...
      requiredSkills: ["Scikit-learn", "Model Evaluation", "ML Algorithms", "Feature Engineering"],
      description: "Master core machine learning concepts, algorithms, and evaluation techniques using industry-standard tools.",
      topicNames: [
      ...
      resources: [
        {
          name: "ML Algorithms Course - CampusX",
          type: "course",
  ...
  capstoneProject: {
    title: "End-to-End ML Application: Smart Recommendation System",
    description: "Build a complete machine learning application from data collection to deployment.",
    skillsUsed: ["Full Stack ML", "API Development", "Cloud Deployment", "System Design"],
    topicNames: [
      ...
      "Frontend Development (React/Streamlit)",
...
const PersonalizedRoadmap = () => {
  ...
  useEffect(() => {
    ...
    data.personalizedSteps.forEach((step, stepIndex) => {
      const stepKey = `step-${stepIndex}`;
      const checkedCount = Math.floor(((step.progress || 0) / 100) * step.topicNames.length);
      initialCheckedTopics[stepKey] = new Set(step.topicNames.slice(0, checkedCount));
    });

    const capstoneCheckedCount = Math.floor(
      ((data.capstoneProject.progress || 0) / 100) * data.capstoneProject.topicNames.length
    );
    initialCheckedTopics["capstone"] = new Set(data.capstoneProject.topicNames.slice(0, capstoneCheckedCount));
  ...
  const calculateOverallProgress = () => {
    ...
    data.personalizedSteps.forEach((step, index) => {
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl relative z-10">
        ...
        >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-800">
                    $<AnimatedCounter value={parseInt(data.salary.replace("k", ""))} suffix="k" />
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="bg-white/95 backdrop-blur-xl border-blue-200/50 hover:border-blue-300 transition-all duration-300 group shadow-lg hover:shadow-xl">
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                <div className="p-3 bg-gradient-to-r from-blue-500 to-sky-500 rounded-xl group-hover:scale-110 transition-transform duration-300 shadow-lg">
                  <Icons.BarChart3 />
                </div>
                <div>
          ...
          <Card className="bg-white/95 backdrop-blur-xl border-blue-200/50 hover:border-cyan-300 transition-all duration-300 group shadow-lg hover:shadow-xl">
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                <div className="p-3 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-xl group-hover:scale-110 transition-transform duration-300 shadow-lg">
                  <Icons.Target />
                </div>
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-800">
                    ...
                    />
                    /
                    {data.personalizedSteps.reduce((acc, step) => acc + step.topicNames.length, 0) +
        ...
        <div className="mb-16">
          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              {data.personalizedSteps.map((step, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Card className={`ml-16 bg-white/95 backdrop-blur-xl border-blue-200/50 hover:border-blue-300 transition-all duration-300 group shadow-lg hover:shadow-xl ${
                          ...
                          <div className="flex-1">
                            <div className="flex items-center justify-between mb-3">
                              <CardTitle className="text-xl text-gray-800 group-hover:text-blue-600 transition-colors flex items-center gap-2">
                                {step.title}
                                <Icons.ChevronDown className={`transition-transform duration-200 ${isActive ? 'rotate-180' : ''}`} />
                              </CardTitle>
                              <div className="flex items-center gap-2">
                                <Badge className={getDifficultyColor(step.difficulty || "")}>{step.difficulty}</Badge>
                                <Badge variant="outline" className="flex items-center gap-1 text-gray-600 border-gray-300">
                                  <Icons.Clock />
                                  {step.estimatedTime}
                                </Badge>
                              </div>
                                ...
                                {step.topicNames.map((topic, topicIndex) => (
                                  ...
                                  >
                                    <Checkbox
                                      ...
                                      checked={checkedTopics[stepKey]?.has(topic) || false}
                                      onCheckedChange={(checked) =>
                                        handleTopicCheck(stepKey, topic, checked)
                                      }
                                    ...
                                    <label
                                      ...
                                      className={`text-sm cursor-pointer flex-1 ${
                                        checkedTopics[stepKey]?.has(topic)
          ...
          <Card className="relative overflow-hidden bg-gradient-to-r from-blue-50 to-sky-50 backdrop-blur-xl border-blue-200 shadow-2xl">
            ...
            <CardHeader className="relative">
              <CardTitle className="flex items-center gap-3 text-2xl text-gray-800">
                <div className="p-3 bg-gradient-to-r from-blue-500 to-sky-500 rounded-xl shadow-lg text-white">
                  🏆
                </div>
                Capstone Project
                    ...
                    {data.capstoneProject.topicNames.map((topic, topicIndex) => (
                      ...
                      >
                        <Checkbox
                          ...
                          checked={checkedTopics["capstone"]?.has(topic) || false}
                          onCheckedChange={(checked) => handleTopicCheck("capstone", topic, checked)}
                          className="accent-blue-500"
                        />
                        <label
                          htmlFor={`capstone-${topicIndex}`}
                          className={`text-sm cursor-pointer flex-1 ${
                            checkedTopics["capstone"]?.has(topic) ? "line-through text-gray-500" : "text-gray-700"
                          }`}
                        >
                          {topic}
                        </label>
