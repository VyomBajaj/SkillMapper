...
const ProfilePage = ({ user = {} }) => {
  ...
  /* USER DATA */
  const userData = {
    username: user.username || 'johndevlearner',
    email: user.email || 'john@example.com',
    designation: user.designation || 'Full Stack Developer',
    bio:
      user.bio ||
      'Passionate full‑stack developer with 3+ years of experience building modern web applications. I love creating efficient, scalable solutions and am always eager to learn new technologies. Currently focusing on advanced React patterns and cloud architecture.',
    skills:
      user.skills || [
        'JavaScript',
        'React',
  ...
  useEffect(() => {
    ...
    /* Progress bar fill */
    progressObserverRef.current = new IntersectionObserver(
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            setTimeout(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-white to-slate-100 font-sans">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div
          data-section="header"
          className={`mb-8 bg-white rounded-lg shadow-lg overflow-hidden border border-blue-100 transition-all duration-700 ${
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div
              data-section="bio"
              className={`bg-white rounded-lg shadow-lg p-6 border border-slate-100 transition-all duration-700 ${
                animatedSections.has('bio') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
            >
            ...
            <div
              data-section="goal"
              className={`bg-white rounded-lg shadow-lg p-6 border border-slate-100 transition-all duration-700 ${
                animatedSections.has('goal') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
            >
              <h2 className="text-2xl font-bold text-slate-800 mb-6 flex items-center">
                <TargetIcon />
          ...
          <div className="space-y-8">
            ...
            <div 
              data-section="social"
              className={`bg-white rounded-lg shadow-lg p-6 border border-slate-100 transition-all duration-600 delay-100 ${
                animatedSections.has('social') 
            ...
            <div 
              data-section="stats"
              className={`bg-white rounded-lg shadow-lg p-6 border border-slate-100 transition-all duration-600 delay-200 ${
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                  <div className="flex items-center">
                    <TrophyIcon />
                    <span className="ml-3 text-slate-700">Achievements</span>
                  </div>
